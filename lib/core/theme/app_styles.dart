...
abstract class AppStyles {
  ...
  static TextStyle secondaryBold26 = TextStyle(
    fontSize: ResponsizeSizer.getResponsiveFontSize(26),
  ...
  static TextStyle secondaryBold24 = TextStyle(
    fontSize: ResponsizeSizer.getResponsiveFontSize(24),
    fontFamily: AppFonts.secondaryFontFamily,
  ...
  static TextStyle secondaryBold20 = TextStyle(
    fontSize: ResponsizeSizer.getResponsiveFontSize(20),
    fontFamily: AppFonts.secondaryFontFamily,
    color: AppColors.textPrimaryColor,
    fontWeight: FontWeight.bold,
  );
  ...
  static TextStyle secondaryMedium18 = TextStyle(
    fontSize: ResponsizeSizer.getResponsiveFontSize(18),
    fontFamily: AppFonts.secondaryFontFamily,
    color: AppColors.textPrimaryColor,
  ...
  static TextStyle secondaryMedium14 = TextStyle(
    fontSize: ResponsizeSizer.getResponsiveFontSize(14),
    fontFamily: AppFonts.secondaryFontFamily,
    color: AppColors.primaryColor,
    fontWeight: const FontWeight(500),
  );
  ...
  static TextStyle primaryBold16 = TextStyle(
    fontSize: ResponsizeSizer.getResponsiveFontSize(16),
